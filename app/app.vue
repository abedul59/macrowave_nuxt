<template>
  <div>
            ...
            <div class="card-body">
                <div class="row align-items-center text-center">
                    ...
                    <div class="col-md-6 border-start">
                        ...
                        <small class="text-muted d-block mt-1" style="font-size: 0.75rem;">作為 API 傳輸外的備用選項</small>
                    </div>
                </div>
    ...
    <div v-else class="text-center mt-5">
      ...
      <p class="mt-2 text-muted fw-bold">載入最新戰情數據中...</p>
    </div>
...
// 定義響應式資料，存放從 API 拿到的數據
const rawResponseData = ref(null)

// 透過自建的 API 取得 Supabase 裡最新的一筆資料
...
// 允許直接在網頁端選擇本機 JSON 檔案來預覽 (不上傳資料庫)
